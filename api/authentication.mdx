...
description: "All WizzGift API endpoints require authentication. Every request—GET, POST, or any other method—must include your API Key in the Authorization header using the Bearer Token format."
